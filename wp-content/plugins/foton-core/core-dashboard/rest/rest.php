...
if ( ! class_exists( 'FotonCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class FotonCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'foton-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'foton_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	FotonCoreDashboardRestAPI::get_instance();
}